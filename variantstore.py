...
class Variant(Model):
    ...
    sample = columns.Text(primary_key=True, index=True)
    library_name = columns.Text(primary_key=True)
    target_pool = columns.Text(primary_key=True)
    panel_name = columns.Text(primary_key=True, index=True)
    extraction = columns.Text(primary_key=True, index=True)
    reference_genome = columns.Text(primary_key=True, index=True)
