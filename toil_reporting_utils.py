...
def create_report(job, report_data, sample, samples, callers, thresholds):
    ...
    for variant in report_data['']:
        ...
        tier1_sheet.cell(row=row, column=16, value="{}".format(target_amplicon_coverage[variant.amplicon_data['amplicon']]['mean_coverage']))
        tier1_sheet.cell(row=row, column=17, value="{}".format(target_amplicon_coverage[variant.amplicon_data['amplicon']]['num_reads']))
